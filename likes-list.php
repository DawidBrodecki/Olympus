	...
	?>
		...
		<div id="upperbar">
			...
			<div id="Mainbar">
				...
				<div id="NavOptions">
					<div class="NavOptions">Moje polubienia:</div> 
							
					<div id="search-header" style="float:right; margin-top:2px;">
							<div style="float:left"><i class="fas fa-search fa-2x" style="margin-left:8px; padding-top:1rem; color: #818181;"></i></div>
							<div style="float:left"><input  id="search" class="search" name="search" type="search" placeholder="Przeszukaj Olympusa..."   autocomplete="off" novalidate /></div>
							<div style="clear:both;"></div>
						<div id="display_search"></div>
					...
					<div class="columnleft">
						<div class="friend">
							<table style="float:left;">
								<tr>
									<td><img class="friendsphoto" src="img/winky.png" width="90px" height="90px"></td> <td><div class="friend-style">Nazwa fanpage</div></td>
								</td>
							</table>
